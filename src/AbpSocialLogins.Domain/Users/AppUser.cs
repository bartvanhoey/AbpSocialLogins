...
namespace AbpSocialLogins.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AbpSocialLoginsDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AbpSocialLoginsEfCoreEntityExtensionMappings to extend the IdentityUser entity
