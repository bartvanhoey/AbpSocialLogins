...
{
    public class AbpSocialLoginsDbMigrationService : ITransientDependency
    {
        public ILogger<AbpSocialLoginsDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IAbpSocialLoginsDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public AbpSocialLoginsDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IAbpSocialLoginsDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<AbpSocialLoginsDbMigrationService>.Instance;
        }
